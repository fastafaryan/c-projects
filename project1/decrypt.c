/*
 * decrypt.c
 * This program will decrypt messages int argc, char *argv[].
 * Fatih 
 */
...
int main(int argc, char *argv[]){	
	...
	/* original plain english alphabet, do not change this.*/
	char palpha[36]= "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
    char calpha[36];  /* your new alphabet to be used in the encryption */
